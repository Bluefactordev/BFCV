''' pietra miliare, versione priva di bug eclatanti, sera del 5 marzo 2025'''
...
def process_cvs(cv_dir, job_description, fields, progress_callback=None):
    ...
    if fields is None:
        ...
        st.warning("Campi non specificati, utilizzo di campi predefiniti")
...
with st.sidebar:
    ...
    # Lista predefinita di campi disponibili
    available_fields = [
        "Nome", "Numero di contatto", "Email", "Età", "Città di residenza", 
        "Anni di esperienza lavorativa", "Formazione più alta", "Università/Istituto"
    ]
    ...
    selected_fields = st.multiselect(
        "Seleziona i campi da estrarre",
        available_fields,
        default=["Nome", "Email", "Anni di esperienza lavorativa", "Formazione più alta"],
        key="fields_multiselect_sidebar"
    )
    
    # Salva i campi selezionati nella session state
    if selected_fields:
...
def main():
    ...
    if "fields" not in st.session_state:
        st.session_state.fields = [
            ...
            "Anni di esperienza lavorativa", "Formazione più alta",
            "Competenze tecniche", "Competenze linguistiche",
            "Posizione attuale", "Legame con Firenze",
            "Età", "Città di residenza", "Disponibilità a trasferirsi",
            "Settore di esperienza", "Soft skills", "Lingue straniere",
            "Certificazioni", "Conoscenze informatiche", "Aspirazioni professionali",
            "Forza principale", "Debolezza principale", "Fit generale"
        ]
